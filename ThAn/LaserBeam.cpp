...
{
	float r_laser = 0.000025;
	Laser_Intensity = ((2*W)/(4.0*atan(1)*r_laser*r_laser))*pow(2.7183, (-(2*(pow((PP.x_p[cell][particle] - i*delta_t*speed), 2) + pow((PP.y_p[cell][particle] - 0.0005), 2)))/(pow(r_laser, 2))));
