...
hold on
for i = 1:element_count
    l1 = linspace(x(element(i, 1)) + u(6*(element(i, 1) - 1) + 1), x(element(i, 2)) + u(6*(element(i, 2) - 1) + 1), 100);
    l2 = linspace(y(element(i, 1)) + u(6*(element(i, 1) - 1) + 2), y(element(i, 2)) + u(6*(element(i, 2) - 1) + 2), 100);
    l3 = linspace(z(element(i, 1)) + u(6*(element(i, 1) - 1) + 3), y(element(i, 2)) + u(6*(element(i, 2) - 1) + 3), 100);
    plot3(l1, l2, l3, 'r-');
    hold on
end